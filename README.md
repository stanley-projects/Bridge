...
Apple Maps Redirect catches `maps.apple.com` links and shared Apple Maps text, converts the location into a Google Maps-compatible link, then lets you open it with Google Maps, Waze, or any other installed maps app that handles `geo:` links.
